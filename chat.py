...
class ChatApplication:
    def __init__(self):
        ...
        llm = self._get_llm()
        self.chain = self._create_chain(llm, retriever)
    ...
    def _create_chain(
        ...
        retriever_chain = self._create_retriever_chain(llm, retriever) | RunnableLambda(
            self._format_docs
        ...
        return (
            {
                ...
                "chat_history": RunnableLambda(self._serialize_history).with_config(
    ...
    def _serialize_history(self, request: ChatRequest):
